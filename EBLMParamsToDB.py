...
def argParse():
    ...
    parser.add_argument('--swasp_ids',help='cross match the swasp_ids',action='store_true')
...
if args.swasp_ids:
    ...
    qry="SELECT image_id,object_name FROM eblm_ids_new WHERE utmiddle > '2012-05-14T12:00:00' AND utmiddle < '2012-05-15T12:00:00' AND swasp_id IS NULL"
